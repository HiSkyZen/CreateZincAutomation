package me.hisky.createzincautomation;
...
@Mod(CreateZincAutomation.MODID)
public class CreateZincAutomation {
    public static final Logger LOGGER = LogManager.getLogger(CreateZincAutomation.class);
    public static final String MODID = "createzincautomation";

    public CreateZincAutomation() {
    ...
    public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(
            new ResourceLocation(CreateZincAutomation.MODID, CreateZincAutomation.MODID), () -> "1", "1"::equals,
            "1"::equals);
